...
from erp.models import Game, Team
...
def match(request):
    ...
    return render(request, 'mysite/match.html', context)
...
def roster(request):
    ...
    return render(request, 'mysite/roster.html', context)
